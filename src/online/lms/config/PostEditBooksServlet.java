...
public class PostEditBooksServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean status = admin.editBook(book);
		if (status) {
			response.sendRedirect("/Online_LMS/Serverpages/index.jsp?page=6&book_edited=edited&id="+id);
		} else {
			response.sendRedirect("/Online_LMS/Serverpages/index.jsp?page=6&book_edited=unedited&id="+id);
		}
	}
