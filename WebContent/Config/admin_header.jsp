            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="${pageContext.request.contextPath }/Serverpages/index.jsp?page=2">Create User</a></li>
                        <li><a href="${pageContext.request.contextPath }/Serverpages/index.jsp?page=3">List Users</a></li>
                        <li><a href="${pageContext.request.contextPath }/Serverpages/index.jsp?page=4">Approve Users</a></li>
                        <li class="dropdown-header">Books</li>
                        <li><a href="${pageContext.request.contextPath }/Serverpages/index.jsp?page=5">Create Book</a></li>
                        <li><a href="${pageContext.request.contextPath }/Serverpages/index.jsp?page=6">List Books</a></li>
                        <li class="dropdown-header">Faculties</li>
                        <li><a href="${pageContext.request.contextPath }/Serverpages/index.jsp?page=7">Create Faculty</a></li>
                        <li><a href="${pageContext.request.contextPath }/Serverpages/index.jsp?page=8">List Faculties</a></li>
                    </ul>
                </li> 
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="${pageContext.request.contextPath }/Serverpages/index.jsp?page=10">List Granted</a></li> 
                        <li><a href="${pageContext.request.contextPath }/Serverpages/index.jsp?page=11">Requests</a></li>    
                        <li class="dropdown-header">Extras</li>                  
                        <li><a href="${pageContext.request.contextPath }/Serverpages/index.jsp?page=12">Fine</a></li>
                        <li><a href="${pageContext.request.contextPath }/Serverpages/index.jsp?page=13">Setting</a></li>
                    </ul>
                </li>
                <li class="dropdown">
